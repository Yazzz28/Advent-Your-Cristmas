...
class HomeManager extends AbstractManager
{
    ...
    public function selectAllContenu(int $user_id, string $orderBy = '', string $direction = 'ASC'): array
    {
        ...
        INNER JOIN film ON film.id = contenu.film_id WHERE contenu.user_id =' . $user_id;
        if ($orderBy) {

            ...
            .then((data) => {
                ...
                if (data.errorsLogin) {
                    if (data.errorsLogin.email) {
                        const errorsLoginEmail =
                            document.querySelector("#errorsEmail");
                        errorsLoginEmail.setAttribute(
                            "placeholder",
                            data.errorsLogin.email
                        );
                    }
                    if (data.errorsLogin.password) {
                        const errorsLoginPassword =
                            document.querySelector("#errorsPassword");
                        errorsLoginPassword.setAttribute(
                            "placeholder",
                            data.errorsLogin.password
                        );
                    }
                }
